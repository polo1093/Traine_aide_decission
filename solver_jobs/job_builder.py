...
def build_solver_job(
    *,
    ...
    hero_solver_player: int = 0,
    villain_solver_player: int | None = None,
    decision_actor: str = "hero",
    root_must_be_hero: bool = True,
    hero_position_model: str = "unknown",
    decision_context_type: str = "unknown",
    initial_hole_cards: list[list[str]] | tuple[tuple[str, ...], ...] | None = None,
    initial_contributions: list[float] | tuple[float, float] | None = None,
    ...
    try:
        job = {
            ...
            "villain_solver_player": 1 - hero_solver_player if villain_solver_player is None else villain_solver_player,
